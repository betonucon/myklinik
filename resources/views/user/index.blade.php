...
@section('content')
        ...
        <div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">List User Akses <small></small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
        ...
        <script type="text/javascript">
            ...
            function switch_data(id,act){
                if(act==1){
                    ...
                    swal({
                            title: "Aktifkan akun?",
                            text: "Jika diaktifkan maka pengguna dapat menggunakan akun ini",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
                ...
                if(act==0){
                    swal({
                            ...
                            text: "Jika nonaktifkan maka pengguna tidak dapat menggunakan akun ini",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
