...
@section('content')
        ...
        <div id="content" class="content">
			...
			<h1 class="page-header">Formulir Poli<small></small></h1>
			<div class="row">
						...
						<div class="panel-body">
                            <form  id="mydata" method="post" action="{{ url('user') }}" enctype="multipart/form-data" >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-12 ">
                                        <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Formulir data Poli</legend>
                                    </div>
                                    <div class="col-xl-12 ">
                                        
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-2 text-lg-right col-form-label">Kode Poli <span class="text-danger">*</span></label>
                                            <div class="col-lg-9 col-xl-2">
                                                <input type="text" {{$disabled}} name="kode_poli" value="{{$kode_poli}}" placeholder="Ketik...." class="form-control">
                                            </div>
                                        </div>
                                        
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-2 text-lg-right col-form-label">Nama Poli <span class="text-danger">*</span></label>
                                            <div class="col-lg-9 col-xl-8">
                                                <input type="text" name="nama_poli" value="{{$data->nama_poli}}" placeholder="Ketik...." class="form-control">
                                            </div>
                                        </div>
...
@push('ajax')
        ...
        <script type="text/javascript">
			...
			function tambah(id){
				location.assign("{{url('poli/view')}}?id="+id)
			} 
			function kembali(){
				location.assign("{{url('master/poli')}}")
			} 
                                ...
                                $.ajax({
                                    ...
                                    success: function(msg){
                                        ...
                                        var tables=$('#data-table-fixed-header').DataTable();
                                            tables.ajax.url("{{ url('master/poli/getdata')}}").load();
                                    }
                                });
