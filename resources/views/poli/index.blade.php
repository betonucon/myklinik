...
@section('content')
        ...
        <div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">List Poli <small></small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
...
@push('ajax')
        ...
        <script type="text/javascript">
			...
			function tambah(id){
				location.assign("{{url('master/poli/view')}}?id="+id)
			} 
            ...
            function switch_data(id,act){
                if(act==1){
                    ...
                    swal({
                            title: "Aktifkan poli?",
                            text: "Jika diaktifkan maka pengguna dapat menggunakan poli ini",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
                        ...
                        if (willDelete) {
                            $.ajax({
                                type: 'GET',
                                url: "{{url('master/poli/switch_status')}}",
                                data: "id="+id+"&act="+act,
                                success: function(msg){
                                    swal("Sukses diproses", "", "success")
                                    var tables=$('#data-table-fixed-header').DataTable();
                ...
                if(act==0){
                    swal({
                            title: "Non aktifkan poli?",
                            text: "Jika nonaktifkan maka pengguna tidak dapat menggunakan poli ini",
                            icon: "warning",
                            buttons: true,
                            dangerMode: true,
                        })
