                                <div class="row">
                                    ...
                                    <div class="col-xl-12 ">
                                        ...
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-4 text-lg-right col-form-label">Stok & Satuan<span class="text-danger">*</span></label>
                                        ...
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-4 text-lg-right col-form-label">Harga<span class="text-danger">*</span></label>
                                            <div class="col-lg-8 col-xl-3">
                                                <input type="text" name="harga" id="harga_obat"  value="{{$harga}}" placeholder="Ketik...." class="form-control typeuang">
                                            </div>
                                        </div>
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-4 text-lg-right col-form-label">Qty<span class="text-danger">*</span></label>
                                            <div class="col-lg-8 col-xl-2">
