...
@section('content')
        ...
        <div id="content" class="content">
			<ol class="breadcrumb float-xl-right">
				...
				<li class="breadcrumb-item active">Metode Bayar / Jenis Asuransi</li>
			</ol>
			<h1 class="page-header">Formulir Metode Bayar / Jenis Asuransi<small></small></h1>
			<div class="row">
				...
				<div class="col-xl-12 ui-sortable">
					...
					<div class="panel panel-inverse">
						...
						<div class="panel-body">
                            <form  id="mydata" method="post" action="{{ url('master/asuransi') }}" enctype="multipart/form-data" >
                                 @csrf
                                 <!-- <input type="submit"> -->
                                <div class="row">
                                    <input type="hidden" name="id" value="{{$id}}">
                                    <div class="col-xl-12 ">
                                        <legend class="no-border f-w-700 p-b-0 m-t-0 m-b-20 f-s-16 text-inverse">Formulir Data Metode Bayar / Jenis Asuransi</legend>
                                    </div>
                                    <div class="col-xl-12 ">
                                        
                                        <div class="form-group row m-b-10">
                                            <label class="col-lg-2 text-lg-right col-form-label">Nama asuransi <span class="text-danger">*</span></label>
                                            <div class="col-lg-9 col-xl-8">
                                                <input type="text" name="nama_asuransi" value="{{$data->nama_asuransi}}" placeholder="Ketik...." class="form-control">
                                            </div>
                                        </div>
...
@push('ajax')
        ...
        <script type="text/javascript">
			...
			function kembali(){
				location.assign("{{url('master/asuransi')}}")
			} 
